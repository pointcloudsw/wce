...
<article class="accordion">
    <input class="accordion-heading" type="checkbox" id="check-1" />
    <label class="accordion-heading" for="check-1">
...
<article class="accordion">
    <input class="accordion-heading" type="checkbox" id="check-2" />
    <label class="accordion-heading" for="check-2">
...
<article class="accordion">
    <input class="accordion-heading" type="checkbox" id="check-3" />
    <label class="accordion-heading" for="check-3">
...
<article class="accordion">
    <input class="accordion-heading" type="checkbox" id="check-3b" />
    <label class="accordion-heading" for="check-3b">
        Landing Zones AWS Organizations, Consolidated Billing and EC2 Reserved Instances, Consolidated Billing and EC2 Reserved Instances
    </label>
    <section>
    </section>
</article>
...
<article class="accordion">
    <input class="accordion-heading" type="checkbox" id="check-4" />
    <label class="accordion-heading" for="check-4">
        ## Landing Zones
    </label>
    <section>
    </section>
