...
<details>
    ...
    AWS Organizations provides the following functionality:
    <Image src={AwsOrgsFunc} width="720" alt="Capabilities of AWS Organizations" style={"margin: auto;"} />

    These capabilities enable cloud administrators to centralize the following activties:
    ...
    <Image src={AwsOrgsHier} width="840" alt="AWS Organizations Hierachy Example" style={"margin: auto;"} />
