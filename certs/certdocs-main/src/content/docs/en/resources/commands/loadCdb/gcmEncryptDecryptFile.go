...
func main() {
	...
	pt := flag.String("p", "", "Input string to encrypt or decrypt")
	fn := flag.String("f", "", "Input file to to encrypt or decrypt")
	op := flag.String("o", "", "Operation (encrypt or decrypt)")
	kk := flag.String("k", "", "Key encryption key")
