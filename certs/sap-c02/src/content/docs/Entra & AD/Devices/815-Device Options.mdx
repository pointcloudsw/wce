...
<Image src={dsap} alt="Entra Admin Device Settings" width="750" />
...
<table style="border-bottom: none;"><tr><td colspan="3"><b>Entra Device Identity Methods</b></td></tr><tr style="border-bottom: none;"><td><Image src={aard} width="205" alt="Entra Registered Device" />Entra Registered</td><td><Image src={aajd} width="330" alt="Azure Active Directory joined device" />ADDS joined</td><td><Image src={aahjd} width="330" alt="Azure Active Directory hybrid joined device" />Entra+ADDS Hybrid-joined</td></tr></table>
...
<Image src={dsap} alt="Entra Device Settings Screen" width="750" />
