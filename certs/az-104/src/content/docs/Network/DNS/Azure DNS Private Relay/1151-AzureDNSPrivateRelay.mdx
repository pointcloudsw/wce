---
title: Azure DNS Private Relay
sidebar:
    order: 1151
---
import {Image} from 'astro:assets'
import rah from '/src/assets/Network/DNS/resolver-architecture-highres.png'
...
<Image src={rah} alt="Azure DNS Private Resolver architecture" width="750" />
