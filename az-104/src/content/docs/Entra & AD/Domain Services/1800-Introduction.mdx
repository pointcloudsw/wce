...
<span class="fcontainer"><figure><Image src={ImgEntraAdmCtrSec} alt="Entra Admin Center Sec" width="750" /><figcaption>Entra Admin Center Domain Services Legacy Apps example</figcaption></figure>
<p>Easily migrate on-premises apps to a managed domain. Streamline management of all applications from your legacy, directory-aware apps alongside your modern cloud apps with a single identity solution.</p></span>
</div>
